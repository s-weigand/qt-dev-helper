"""Tests for ``qt_dev_helper.transpiler``."""
...
def clean_text(text: str) -> str:
    """Clean autogenerated files before comparing."""
...
def test_build_all_assets_as_packaging_buildsystem(dummy_config: Config):
    ...
    req_index = toml_config["build-system"]["requires"].index("qt-dev-helper")
    toml_config["build-system"]["requires"][req_index] = qt_dev_helper_requirement
